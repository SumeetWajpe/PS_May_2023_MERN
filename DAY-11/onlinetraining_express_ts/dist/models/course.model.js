...
exports.courses = exports.CourseModel = void 0;
class CourseModel {
    constructor(id = 0, title = "", price = 0, rating = 0, likes = 0, imageUrl = "", trainerName = "", avatarUrl = "", description = "") {
        this.id = id;
        this.title = title;
        this.price = price;
        this.rating = rating;
...
exports.courses = [
    ...
    },
    {
        ...
        avatarUrl: "https://i.pravatar.cc/300",
        imageUrl: "https://i0.wp.com/css-tricks.com/wp-content/uploads/2022/01/node-js-logo.png?fit=1200%2C600&ssl=1",
    ...
    },
    {
        ...
        avatarUrl: "https://i.pravatar.cc/300",
        imageUrl: "https://fs.hubspotusercontent00.net/hubfs/6426302/Imported_Blog_Media/7fad34d867a32f732b37534ff013e916-3-2.jpg",
    ...
    },
    {
        ...
        description: "Flutter is an open-source UI software development kit created by Google. It is used to develop cross-platform applications for Android, iOS, Linux, macOS, Windows, Google Fuchsia, and the web from a single codebase. First described in 2015, Flutter was released in May 2017.",
    },
];
